...
namespace GalaxyGourd.Inventory
{
    public static class UIUtility 
    {
        ...
        public static Vector3[] GetScreenCorners(Vector3[] corners, RectTransform target, Camera cam)
        {
        ...
        public static Rect RendererBoundsInScreenSpace(Renderer r, Camera cam, out Vector3[] screenSpaceCorners) 
        {
        ...
        public static Rect PointsBoundsInScreenSpace(Vector3[] points, Camera cam)
        {
